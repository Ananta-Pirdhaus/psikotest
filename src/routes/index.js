...
const MasterPendidikan = lazy(() =>
  import("../pages/protected/MasterPendidikan")
);
const MasterKampus = lazy(() => import("../pages/protected/MasterKampus"));
...
const routes = [
  ...
  {
    path: "/master-kampus",
    component: MasterKampus,
  },
  {
    path: "/master-jurusan",
    component: MasterJurusan,
  },
  {
    path: "/master-region",
